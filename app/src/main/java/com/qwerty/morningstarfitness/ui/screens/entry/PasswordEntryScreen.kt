...
fun PasswordEntryScreen(
    ...
    Column(
        ...
        Text(
            text = "Verify your account password to enter the gym without scanning your QR code.",
        ...
        Text(
            text = "Your email is taken from the account already signed in; you do not need to enter it again.",
            color = PulseColors.TextMuted,
            fontSize = 11.sp,
            textAlign = TextAlign.Center,
